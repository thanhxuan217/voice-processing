...
JSON_PATH = "./alignResult/giao_duc_cong_dan_aligned_result.json"
OUTPUT = "./alignResult/giao_duc_cong_dan_aligned_result_corrected.json"

BOOK_TITLE = "Bộ sách cánh diều - Giáo Dục Công Dân lớp 9"
